...
*Guests:* ${form.guests}`;
    ...
    return (
        <section className="w-full flex items-center justify-center">
            <Link to="/"><div className=" bg-black flex items-center justify-center absolute size-10 rounded-full top-5 left-5">
                    ...
                    <div className="h-20 mt-5 w-full flex items-center justify-center col-span-full">
                        <button
                           onClick={
                            ...
                            type="submit"
                            className={`cursor-pointer hover:bg-black/80 transition-all h-15 md:w-[40%] w-[70%] ${btn?"bg-black/80":"bg-black"} text-white text-lg font-semibold rounded-3xl py-2`}
                        >
                            Submit
                        </button>
                    </div>
