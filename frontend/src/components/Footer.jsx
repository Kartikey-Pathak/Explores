        ...
        <section className=" w-full  h-full bg-black flex items-center justify-start flex-col">
            ...
            <div className=" mt-5 flex flex-col  items-center justify-start md:justify-center">
                ...
                <div className=" mt-5 gap-6 flex w-[90%] flex-col items-start justify-start">
                    ...
                    <div className=" flex flex-row gap-4"><i class="fa-solid font-semibold fa-envelope text-gray-400 text-xl"></i>
                    ...
                    }}><i className="fa-brands font-semibold text-3xl cursor-pointer hover:text-white transition-all text-gray-500 fa-whatsapp"></i></a>
                        <a href="https://www.instagram.com/travelexplores5"
                        ><i class="fa-brands font-semibold text-3xl cursor-pointer hover:text-white transition-all text-gray-500 fa-instagram"></i></a>
                    </div>
                </div>
